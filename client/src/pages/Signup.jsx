...
const SOCIAL_BUTTON_CLASSES = "w-full bg-white/5 hover:bg-white/10 border border-white/10 text-white font-medium py-3.5 rounded-xl transition-all flex items-center justify-center gap-3";
const CHECKBOX_CLASSES = "h-4 w-4 rounded border-white/10 bg-white/5 text-indigo-400 focus:ring-indigo-400/50 focus:ring-offset-0";
      ...
      >
        ...
        >
          <div className="space-y-2">
            <label className="block text-left text-sm font-medium text-gray-300 ml-1">
              Full Name
            </label>
            ...
            <div className="text-sm">
              <label htmlFor="terms" className="font-medium text-gray-300">
                I agree to the <Link
                  to="/terms"
                  style={{ color: '#818cf8' }}
                  className="font-semibold hover:underline hover:text-indigo-300"
                >
                  Terms of Service
                </Link> and <Link
                  to="/privacy"
